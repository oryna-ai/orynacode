export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OrynaCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OrynaCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
