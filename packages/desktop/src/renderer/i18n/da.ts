export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OrynaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OrynaCode er blevet downloadet. Vil du installere den og genstarte?",
