export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OrynaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OrynaCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
