export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of OrynaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of OrynaCode has been downloaded, would you like to install it and relaunch?",
