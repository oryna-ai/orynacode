export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OrynaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OrynaCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
