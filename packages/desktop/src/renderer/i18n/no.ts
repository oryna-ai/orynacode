export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OrynaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OrynaCode er lastet ned. Vil du installere den og starte på nytt?",
