export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OrynaCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OrynaCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
