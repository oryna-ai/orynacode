...
export function userAgent(client = "cli") {
  return `orynacode/${InstallationChannel}/${InstallationVersion}/${client}`
}
  ...
  Effect.gen(function* () {
    ...
    const upgradeCurl = Effect.fnUntraced(
      function* (target: string) {
        const response = yield* httpOk.execute(HttpClientRequest.get("https://oryna.ai/install"))
    ...
    const result: Interface = {
      ...
      latest: Effect.fn("Installation.latest")(function* (installMethod?: Method) {
        ...
        const response = yield* httpOk.execute(
          HttpClientRequest.get("https://api.github.com/repos/oryna-ai/opencode/releases/latest").pipe(
            HttpClientRequest.acceptJson,
          ),
        )
